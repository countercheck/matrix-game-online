...
- [✓] Define Persona model/schema (added feature)
- [✓] Define ArgumentationComplete model/schema (added feature)
...
- [✓] Validate argument types (FOR, AGAINST, CLARIFICATION, INITIATOR_FOR)
- [✓] Enforce argument limits per player
- [✓] Test adding arguments
- [✓] Test argument limits
- [✓] Track argumentation completion per player (added feature)
- [✓] Only transition to voting when all players have argued and marked complete (added feature)
...
- [✓] Auto-create placeholder arguments for missing players (added feature)
...
- [✓] Test game creation
- [✓] Support persona definition (added feature)
...
- [✓] Support persona selection and display (added feature)
...
- [✓] Group by player
- [✓] Show argument type (FOR/AGAINST/CLARIFICATION/INITIATOR_FOR)
...
- [✓] Show who's still needed (waiting status display)
...
- [✓] Install Playwright or Cypress (using Vitest with supertest for e2e)
